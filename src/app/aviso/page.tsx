  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8 px-4">
      ...
      <main className="max-w-4xl bg-white shadow-lg rounded-lg p-6 mt-6 space-y-4 text-gray-800">
        ...
        <p>
          La tienda de bazar, denominada <strong>Bunid</strong>, ubicada en
          [DIRECCIÓN DE LA TIENDA], es responsable del tratamiento de sus datos
          personales conforme a lo establecido en la Ley Federal de Protección
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Proveer los productos y servicios que ha solicitado, incluyendo la
            gestión de pagos y entregas.
          </li>
          <li>
            Informarle sobre promociones, ofertas especiales o productos nuevos
        ...
        <p>
          ...
          <strong>contacto@bunid.com</strong> o al teléfono [NÚMERO DE
          CONTACTO].
        </p>
        ...
        <p>
          ...
          políticas internas. Le notificaremos mediante nuestra página web en
          caso de realizar modificaciones.
        </p>

        <h2 className="text-xl font-semibold">Contacto</h2>
        <p>
          Si tiene dudas sobre este aviso de privacidad, puede comunicarse con
          nosotros en el correo electrónico <strong>contacto@bunid.com</strong>{" "}
          o visitarnos en nuestra tienda física en [DIRECCIÓN DE LA TIENDA].
        </p>
      </main>
